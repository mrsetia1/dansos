            ...
            <div class="container">
                <div class="form-outer text-center d-flex align-items-center">
                    <div class="form-inner">
                        <div class="logo text-uppercase"><strong class="text-info">MANAJEMEN KEUANGAN</strong></div>
                        <p>Halaman login</p>
                    ...
                    <div class="copyrights text-center">
                        <p><a href="https://fiaangkasa.co.id" class="external">FIA ANGKASA Dev</a></p>
...
<?php /* C:\xampp\htdocs\ci_keuangan\application\views/auth.blade.php */ ?>