<nav class="side-navbar">
    <div class="side-navbar-wrapper">
        ...
        <div class="sidenav-header d-flex align-items-center justify-content-center">
            ...
            <div class="sidenav-header-logo"><a href="{{site_url()}}" class="brand-small text-center"> <strong>F</strong><strong class="text-info">A</strong></a></div>
        </div>
        ...
        <div class="main-menu">
            ...
            <ul id="side-main-menu" class="side-menu list-unstyled">                  
                ...
                <li class=""><a href="{{site_url('auth/logout')}}" class="text-danger btn-logout"> <i class="fa fa-sign-out"></i>Keluar</a></li>
            </ul>
        </div>
    </div>
</nav>
